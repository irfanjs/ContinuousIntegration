...
import com.infosys.dcsc.so.platform.cidb.FindBug;

public class FindbugDataNew implements CIData {
	
	FindBug fb;
	
	public FindbugDataNew(int projectid)
	{
		fb = new FindBug(projectid);
	}
